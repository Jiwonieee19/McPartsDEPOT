...
<div class="row" style="margin: 10px 0 0 0 !important;">
    ...
    <section class="col-lg-12">
        ...
        <div class="container mt-3">
             <h4 class="product-categ">BRAKE SYSTEM</h4>

            <div class="row g-3">
                <?php while ($row = mysqli_fetch_assoc($pBrakeResult)) { ?> 
                <div class="col-md-3">
                    <div class="card custom-card">
                        <img src="assets/images/BRAKE/<?php echo $row['product_image']; ?>" alt="<?php echo $row['product_name']; ?>" class="product-image">
        ...
        <!-- EXHAUST AND FILTER -->
        <div class="container mt-3">
             <h4 class="product-categ">EXHAUST AND FILTER</h4>

            <div class="row g-3">
                <?php while ($row = mysqli_fetch_assoc($pExhaustResult)) { ?> 
                <div class="col-md-3">
                    <div class="card custom-card">
                        <img src="assets/images/EXHAUST/<?php echo $row['product_image']; ?>" alt="<?php echo $row['product_name']; ?>" class="product-image">
                        <div class="card-body product-card">
                            <div class="d-flex flex-row ms-2">
                                <h5 class="card-title"><?php echo $row['product_name']; ?></h5>
                            </div>
        ...
        <!-- OTHERS -->
        <div class="container mt-3">
             <h4 class="product-categ">OTHERS</h4>

            <div class="row g-3">
                <?php while ($row = mysqli_fetch_assoc($pOtherResult)) { ?> 
                <div class="col-md-3">
                    <div class="card custom-card">
                        <img src="assets/images/ATHERS/<?php echo $row['product_image']; ?>" alt="<?php echo $row['product_name']; ?>" class="product-image">
                        <div class="card-body product-card">
                            <div class="d-flex flex-row ms-2">
                                <h5 class="card-title"><?php echo $row['product_name']; ?></h5>
                            </div>
