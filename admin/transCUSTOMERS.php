...
//   }
  ...
  include('../components/fetch_transactions_details.php');
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 header-custom">TRANSACTION DETAILS</h1>
            </div><!-- /.col -->
        </div><!-- /.row -->
            ...
            <div class="col-md-8 right-div">
                <nav class="nav custom-status">
                    <a class="nav-link" style="border-top-left-radius: 0.7rem !important; border-bottom-left-radius: 0.7rem !important; margin-left: 0.5rem !important;color: #00A9C7 !important; background-color: #383838 !important;"
                     href="hisCUSTOMERS.php">Customer</a>
                    <!-- <a class="nav-link" style="pointer-events: none !important;">|</a>
                    <a class="nav-link" href="#">Verified</a>
                    <a class="nav-link" style="pointer-events: none !important;">|</a>
                    <a class="nav-link" href="#">Approved</a>
                    <a class="nav-link" style="pointer-events: none !important;">|</a> -->
                    <a class="nav-link" style="border-top-right-radius: 0.7rem !important; border-bottom-right-radius: 0.7rem !important;" href="hisSUPPLIERS.php">Supplier</a>
                </nav>
            </div>
...
<!-- /.content-header -->
    ...
    <?php 
        include('tables/transCustomerTABLE.php');
    ?>
