                                    ...
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        ...
                                        <div class="modal-body">
                                            <form action="../components/update_user.php" method="POST">
                                                ...
                                                <h5 class="text5">Supplier's Information</h5>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <label>Account</label>
                                                        <input type="text" class="form-control" name="lastname" value="Supplier" style="height: 25px; width: 180px; font-size: 12px;" readonly>
                                                    </div>
                                                    <div class="col-md-3">
