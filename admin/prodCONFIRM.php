...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 header-custom">CHOOSE SUPPLIER</h1> 
        ...
        <div class="row mb-3 custom-div">
            <div class="col-md-8 right-div">
                <nav class="nav custom-status">
                    ...
                    <!-- <a class="nav-link" style="pointer-events: none !important;">|</a> -->
                    <a class="nav-link" style="border-top-right-radius: 0.7rem !important; border-bottom-right-radius: 0.7rem !important; margin-left: 0.5rem !important;color: #00A9C7 !important; background-color: #383838 !important;" 
                    href="prodCONFIRM.php">Supplier</a>
                </nav>
            </div>
            <div class="col-md-4 text-right" style="margin-top: 0.5rem !important;">
                ...
                <button class="btn btn-primary" data-toggle="modal" data-target="#addUserModalNew">New Supplier?</button>
                                ...
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content content">
                                        ...
                                        <div class="modal-body">
                                            <form action="../components/add_prodsuppliers.php" method="POST">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="text" class="form-control" name="supplier_fullname" required style="height: 25px; width: 180px; font-size: 12px;">
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="email" class="form-control" name="supplier_email" style="height: 25px; width: 180px; font-size: 12px;">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label>Contact Number</label>
                                                        <input type="text" class="form-control" name="supplier_contact" required style="height: 25px; width: 180px; font-size: 12px;" maxlength="11">
                                                    </div>
                                                </div>
...
<!-- /.content-header -->
    ...
    <?php 
        include('tables/prodConfirmTABLE.php');
    ?>
