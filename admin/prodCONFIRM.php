...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 header-custom">SUPPLIED BY WHOM?</h1> 
        ...
        <div class="row mb-3 custom-div">
            <div class="col-md-8 right-div">
                ...
                <a class="nav-link active" style="border-radius: 0.7rem !important; margin-left: 0.5rem !important;" href="prodVIEWSTOCK.php">Back to Draft <i class="nav-icon fas fa-box"></i></a>
