...
//   }
  ...
  if (isset($_POST['customer_id'])) {
    ...
    $_SESSION['customer_fullname'] = $_POST['customer_fullname'];
    ...
    <div class="container-fluid">
        ...
        <div class="row mb-3 custom-div">
            <div class="col-md-8 right-div">
                ...
                <a class="nav-link active" style="border-radius: 0.7rem !important; margin-left: 0.5rem !important; color: #00A9C7 !important; background-color: #383838 !important;" href="PRODUCTS1.php">1</a>             
                <a class="nav-link active" style="border-radius: 0.7rem !important; margin-left: 0.5rem !important;" href="PRODUCTS2.php">2</a>             
...
<!-- /.content-header -->
    ...
    <?php 
        include('tables/productSCROLL1.php');
    ?>
...
<script>
    document.getElementById('category').addEventListener('change', function () {
        ...
        const imgPath = 'assets/images/' + selectedCategory + '/';

        document.getElementById('productPreview').src = imgPath;
    });
</script>